<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="CreateAgent, App_Web_jirv_ycr" title="Star Bus: Create Agent" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="center" style="text-align:center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Create Agent" Font-Size= "X-Large"  
                        ...
                        <tbody>
                            <tr>
                                <td align="center" colspan="2" style="padding-bottom:15px">
                                    <strong> Sign Up for New Account</strong></td>
                            </tr>
                            <tr>
                                <td align="right">
