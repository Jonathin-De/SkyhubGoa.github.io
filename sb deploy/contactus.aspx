<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="contasus, App_Web_2ted6jil" title="Star Bus: Contact Us" %>
                                        ...
                                        <td valign="middle" colspan="4" height="40">
                                            <table cellspacing="0" cellpadding="2" width="93%" border="0">
                                                <tbody>
                                                    ...
                                                    <tr valign="top" align="left">
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Brij Mohan Dammani</strong> </font>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Shashi Mohan Dammani</strong> </font>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" align="left">
